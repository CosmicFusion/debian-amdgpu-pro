...
wget http://repo.radeon.com/amdgpu/$amdpro/ubuntu/pool/proprietary/o/opengl-amdgpu-pro/libegl1-amdgpu-pro_"$major"-"$minor"~"$ubuntu"_amd64.deb

wget http://repo.radeon.com/amdgpu/$amdpro/ubuntu/pool/proprietary/o/opengl-amdgpu-pro/libgl1-amdgpu-pro-dri_"$major"-"$minor"~"$ubuntu"_amd64.deb
...
ar -x ../debs/libegl1-amdgpu-pro_"$major"-"$minor"~"$ubuntu"_amd64.deb
...
ar -x ../debs/libgl1-amdgpu-pro-dri_"$major"-"$minor"~"$ubuntu"_amd64.deb
...
ar -x ../debs/libglapi1-amdgpu-pro_"$major"-"$minor"~"$ubuntu"_amd64.deb
...
ar -x ../debs/libgles2-amdgpu-pro_"$major"-"$minor"~"$ubuntu"_amd64.deb
...
mv ./opt/amdgpu-pro/opengl/lib/xorg ./opt/amdgpu-pro/opengl/lib/x86_64-linux-gnu/

mv ./usr/lib/x86_64-linux-gnu/* ./opt/amdgpu-pro/opengl/lib/x86_64-linux-gnu/
...
touch ./etc/ld.so.conf.d/amdgpu-pro-opengl-x86_64.conf

echo "# /opt/amdgpu-pro/opengl/lib/x86_64-linux-gnu" > ./etc/ld.so.conf.d/amdgpu-pro-opengl-x86_64.conf
